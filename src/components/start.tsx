...
export function Start({ setStep }: Props) {
  ...
  return (
    <Transition show={open} appear={true}>
      <div className="mx-auto transition duration-300 ease-in data-[closed]:opacity-0 opacity-100 2xl:max-w-[493px] bg md:absolute z-10 md:max-w-[425px] max-w-[335px] 2xl:left-[5vw] md:left-[50px] md:top-1/2 md:-translate-y-1/2 md:py-7 py-[18px] md:px-8 px-[18px] rounded-[20px] text-white">
        ...
        <p className="md:mb-5 mb-4 2xl:text-[18px] 2xl:leading-[21px] md:text-[15px] text-[11px] leading-[13px] md:leading-[18px]">
          Новый год — это не только ёлка, гирлянды <br /> и праздничное оливье.
          Это ещё и момент, когда <br className="md:hidden block" /> мы с
          радостью (или лёгким ужасом) смотрим{" "}
          ...
          ничего страшного! Ведь Новый год — <br className="md:block hidden" />{" "}
          это про надежду, радость и вдохновение, которые заставляют улыбнуться
          и всё-таки двигаться вперёд.
        </p>
        <p className="md:mb-5 mb-4 2xl:text-[18px] 2xl:leading-[21px] md:text-[15px] text-[11px] leading-[13px] md:leading-[18px]">
          Наш квиз поможет вам взглянуть на свои амбициозные новогодние обещания{" "}
          <br className="md:block hidden" />с долей самоиронии. Он легко
          напомнит о&nbsp;тех целях, которые порой ставятся{" "}
