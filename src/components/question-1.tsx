...
export function Question1({ setStep, setRes }: Props) {
  ...
  return (
    <Transition show={open} appear={true}>
      <div className="max-w-[335px] transition duration-300 ease-in data-[closed]:opacity-0 bg md:absolute z-10 mx-auto md:max-w-[394px] 2xl:max-w-[466px] 2xl:left-[5vw] md:left-[50px] 2xl:top-[10vh] md:top-[100px] md:py-7 py-[18px] md:px-8 px-[18px] rounded-[20px] text-white">
        ...
        <div className="grid gap-[10px]">
          ...
          >
            Сплю до обеда, ведь каникулы <br className="md:block hidden" /> для
            отдыха
          </button>
          <button
            type="button"
          ...
          >
            Проверяю, где поблизости спортзал <br className="md:block hidden" />{" "}
            и скидки на абонементы
          </button>
        </div>
      </div>
    </Transition>
