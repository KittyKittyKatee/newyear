...
export function Result3() {
  ...
  return (
    <Transition show={open} appear={true}>
      <div className="transition duration-300 ease-in data-[closed]:opacity-0 bg 2xl:max-w-[409px] md:absolute z-10 md:max-w-[355px] max-w-[335px] mx-auto 2xl:left-[5vw] md:left-[50px] md:top-1/2 md:-translate-y-1/2 md:py-7 py-[18px] md:px-8 px-[18px] rounded-[20px] text-white">
        ...
        <p className="md:mb-6 mb-[30px] 2xl:text-[18px] 2xl:leading-[21px] md:text-[15px] text-[11px] leading-[13px] md:leading-[18px]">
          Твой талант находить отговорки заслуживает отдельной награды. <br className="md:block hidden" />
          Ты точно знаешь, <br className="md:hidden block" /> как перенести <br className="md:block hidden"  /> цели на следующий год без
          лишнего стресса. Вместо выполнения задач ты придумываешь новые, и этот
          цикл делает твою жизнь удивительно насыщенной (но не там, <br className="md:hidden block" /> где надо)
        </p>
        ...
        <p className="md:mb-6 mb-4 2xl:text-[18px] 2xl:leading-[21px] md:text-[15px] text-[11px] leading-[13px] md:leading-[18px]">
          ...
          всего пугает, даже если это займёт 5 минут. <br className="md:block hidden"  /> А если не получится
          — переноси <br className="md:block hidden"  /> с гордостью!
        </p>
        <a
