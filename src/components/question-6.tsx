...
export function Question6({ setStep, setRes }: Props) {
  ...
  return (
    <Transition show={open} appear={true}>
      <div className="transition duration-300 ease-in data-[closed]:opacity-0 2xl:max-w-[498px] bg md:absolute z-10 md:max-w-[425px] max-w-[335px] mx-auto 2xl:left-[5vw] left-[50px] 2xl:top-[10vh] top-[100px] md:py-7 py-[18px] md:px-8 px-[18px] rounded-[20px] text-white">
