...
export function Result4({ step }: Props) {
  ...
  return (
    <Transition show={open} appear={true}>
      <div className="transition duration-500 ease-in data-[closed]:opacity-0 mx-auto w-fit">
        ...
        <div className=" bg 2xl:max-w-[428px] md:absolute z-10 md:max-w-[373px] max-w-[335px]  2xl:left-[5vw] md:left-[50px] md:top-1/2 md:-translate-y-1/2 md:py-7 py-[18px] md:px-8 px-[18px] rounded-[20px] text-white">
          ...
          <p className="md:mb-6 mb-[30px] 2xl:text-[18px] 2xl:leading-[21px] md:text-[15px] text-[11px] leading-[13px] md:leading-[18px]">
            ...
            и&nbsp;выполнять всё, как по часам. <br /> Правда, пока эта
            суперсила где-то задерживается. Но зато ты прекрасно мотивируешь
            друзей: твои советы — огонь!
          </p>
          ...
          <p className="md:mb-6 mb-4 2xl:text-[18px] 2xl:leading-[21px] md:text-[15px] text-[11px] leading-[13px] md:leading-[18px]">
            Позволь себе быть человечным(ой): начни с&nbsp;создания одной
            простой привычки, например, записывать свои планы. И помни, что
            супергероям тоже нужен отдых!
          </p>
          <a
